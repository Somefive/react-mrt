...
export default class MRTViewer extends React.Component {
    ...
    render() {
        ...
        const dataView = new DataView(this.props.data, this.props.userEdits, this.props.hideSubBranch, this.config.EraMinRatio, this.config.LastEraRatio)
        ...
        // return <Layout
        //     config={this.config}
        //     root={dataView.root} grid={dataView.grid}
        // />
