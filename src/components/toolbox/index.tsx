            ...
            <div>
                <div className="toolgroup horizontal">
                    ...
                    {/* <div className="toolgroup secondary vertical">
                        ...
                        <Tool type="file-image" theme="twoTone" color="blue" tooltipText={t("Full Picture")} onClick={() => this.props.capture && this.props.capture(true)}/>
                        <Tool type="camera" theme="twoTone" color="blue" tooltipText={t("Snapshot")} onClick={() => this.props.capture && this.props.capture(false)}/>
                    </div> */}
                    <div className="toolgroup secondary vertical">
